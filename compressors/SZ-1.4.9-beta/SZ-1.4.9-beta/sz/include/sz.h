...
unsigned char *SZ_compress_EE(int dataType, void *data, int *outSize, int r5, int r4, int r3, int r2, int r1, double* err_est);
unsigned char *SZ_compress_args_EE(int dataType, void *data, int *outSize, int errBoundMode, double absErrBound, double relBoundRatio, int r5, int r4, int r3, int r2, int r1, double* err_est);
void SZ_compress_args_double_EE(unsigned char** newByteData, double *oriData, int r5, int r4, int r3, int r2, int r1, int *outSize, int errBoundMode, double absErr_Bound, double relBoundRatio, double* err_est);


void compute_segment_precisions_float_1D_EE(float *oriData, int dataLength, float* pwrErrBound, unsigned char* pwrErrBoundBytes, double* err_est);

void SZ_compress_args_float_NoCkRngeNoGzip_1D_EE(unsigned char** newByteData, float *oriData, int dataLength, double realPrecision, int *outSize, float valueRangeSize, float medianValue_f, double* err_est);
void SZ_compress_args_float_NoCkRngeNoGzip_1D_pwr_EE(unsigned char** newByteData, float *oriData, int dataLength, int *outSize, float min, float max, double* err_est);

void SZ_compress_args_double_NoCkRngeNoGzip_2D_EE(unsigned char** newByteData, double *oriData, int r1, int r2, double realPrecision, int *outSize, double valueRangeSize, double medianValue_d, double* err_est);
void SZ_compress_args_double_NoCkRngeNoGzip_2D_pwr_EE(unsigned char** newByteData, double *oriData, int r1, int r2, int *outSize, double min, double max, double* err_est);
void SZ_compress_args_double_NoCkRngeNoGzip_3D_EE(unsigned char** newByteData, double *oriData, int r1, int r2, int r3, double realPrecision, int *outSize, double valueRangeSize, double medianValue_d, double* err_est);
void SZ_compress_args_double_NoCkRngeNoGzip_3D_pwr_EE(unsigned char** newByteData, double *oriData, int r1, int r2, int r3, 
int *outSize, double min, double max, double* err_est);
