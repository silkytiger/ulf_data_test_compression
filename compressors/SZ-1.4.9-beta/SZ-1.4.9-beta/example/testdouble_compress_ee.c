...
int main(int argc, char * argv[])
{
    ...
    double* err_est = readDoubleData("./err_est.bin", &nbEle);
   
    int outSize;
    cost_start(); 
    unsigned char *bytes = SZ_compress_EE(SZ_DOUBLE, data, &outSize, r5, r4, r3, r2, r1, err_est);
    //unsigned char *bytes = SZ_compress(SZ_DOUBLE, data, &outSize, r5, r4, r3, r2, r1, err_est);
    ...
    cost_end();
    printf("timecost=%f\n",totalCost);
    printf("factor=%.3f\n", (1.*sizeof(double)*computeDataLength(r5, r4, r3, r2, r1)) / (outSize));
