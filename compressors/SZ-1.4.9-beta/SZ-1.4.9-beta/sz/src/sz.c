...
unsigned char* SZ_compress_args_EE(int dataType, void *data, int *outSize, int errBoundMode, double absErrBound, 
double relBoundRatio, int r5, int r4, int r3, int r2, int r1, double* err_est)
{
	//TODO
	if(dataType==SZ_FLOAT)
	{
	...
	{
		unsigned char *newByteData;
		SZ_compress_args_double_EE(&newByteData, (double *)data, r5, r4, r3, r2, r1, 
		outSize, errBoundMode, absErrBound, relBoundRatio, err_est);
...
{	
	unsigned char *newByteData = SZ_compress_args_EE(dataType, data, outSize, errorBoundMode, absErrBound, relBoundRatio, r5, r4, r3, r2, r1, err_est);
	return newByteData;
}
